...
from newsies_common.targets import DOCUMENT

# from newsies_clients.chroma_client import CRMADB
from newsies_common.document_structures import Headline, Document
